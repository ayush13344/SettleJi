...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .input-shell:focus-within {
    ...
    box-shadow: 0 0 0 3px rgba(242,107,91,0.1);
  }
  ...
  .textarea-shell textarea {
    ...
    min-height: 88px; line-height: 1.65;
  }
  ...
  .cat-btn.active {
    ...
    background: var(--coral-bg);
    color: var(--coral);
    box-shadow: 0 4px 14px rgba(242,107,91,0.18);
  }
  ...
  .cover-preview-overlay {
    position: absolute;
    inset: 0;
    background: linear-gradient(to right, rgba(253,250,245,.3), transparent);
  }
  ...
  .member-chip:hover { border-color: var(--purple-bd); }
...
export default function GroupForm() {
  ...
  const handleCreateGroup = async () => {
    try {
      ...
      formData.append("members", JSON.stringify(members.map((m) => ({ name: m.name, initials: m.initials, color: m.color }))));
      ...
      <div className="page">
            ...
            <div className="form-section">
              ...
              <div className="field-block">
                ...
                <div className="input-shell">
                  ...
                  <svg className="chevron-icon" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              <div className="field-block" style={{marginBottom:0}}>
                ...
                <div className="split-grid">
                  {[
                    { id: "equal",      icon: "⚖️", label: "Equal Split" },
                    { id: "percentage", icon: "%",  label: "Percentage" },
                    { id: "custom",     icon: "✏️", label: "Custom" },
                  ].map((s) => (
                    <button
                      type="button"
                      key={s.id}
                      className={`split-btn${splitType === s.id ? " active" : ""}`}
                ...
                <div className="info-box">
                  <span>ℹ️</span>
                  You can change the split type for individual expenses later.
                </div>
              </div>
            </div>
        ...
        <div className="hint-box">
          ...
          <div className="hint-text">
            ...
            <p>After creating a group, you can <span>upload receipts</span> and our AI will automatically split expenses among members.</p>
          </div>
        </div>
